...
"<section class=\"section flight-controls\"><div class=\"head\"><h2>Flight controls</h2><span class=\"meta\">Commands are sent directly to Pico</span></div><div class=\"flight-actions\"><button id=\"wheel-stop\" class=\"danger\" type=\"button\">Wheel stop</button><button id=\"slew-abort\" class=\"danger\" type=\"button\">Abort slew</button><button id=\"angle-reset\" type=\"button\">Angle reset</button><label>Relative angle <input id=\"relative-slew-angle\" type=\"number\" min=\"-360\" max=\"360\" step=\"1\" value=\"1\"> deg</label><button id=\"relative-slew\" class=\"primary\" type=\"button\">Slew</button></div><span class=\"meta\">Relative slew is limited to -360 to +360 degrees. Angle reset is rejected during an active slew.</span></section>"
